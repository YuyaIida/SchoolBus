...
//  UISample
//
//  Created by k16005kk on 2018/07/18.
...
class UniversityViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate{
    ...
    var universityViewTimeData = Timedata()
    ...
    override func viewDidLoad() {
        ...
        let alert: UIAlertController = UIAlertController(title: "登録画面です", message: "", preferredStyle: UIAlertControllerStyle.alert)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        universityViewTimeData.university = searchResults[indexPath.row]
        
        let storyboard: UIStoryboard = self.storyboard!
        let stopoverVC = storyboard.instantiateViewController(withIdentifier: "StopoverPage") as! StopoverViewController
        
        stopoverVC.stopoverViewTimeData = universityViewTimeData
        
        self.navigationController?.pushViewController(stopoverVC, animated: true)
